<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataURL.aspx.cs" Inherits="UTF8Examples_DataURL" %>
    ...
    <form id="form1" runat="server">
        <div id="wrapper">
            ...
            <div id="header">
                ...
                <h1 class="logo-text">FusionCharts ASP.NET(C#) UTF-8 Examples</h1>
            </div>

            <div class="content-area">
                <div id="content-area-inner-main">
                    <h2 class="headline">Example using pre-built Data.xml having multilingual text</h2>
