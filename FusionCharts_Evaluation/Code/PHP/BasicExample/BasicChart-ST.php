...
<HTML>
    <head>
        ...
        <title>FusionCharts - Simple Stacked Column 3D Chart</title>
        ...
        <div id="wrapper">
            ...
            <div id="header">
               ...
               <div class="logo"><a class="imagelink"  href="http://www.fusioncharts.com/" target="_blank"><img src="../assets/ui/images/fusionchartsv3.2-logo.png" width="131" height="75" alt="FusionCharts XT logo" /></a></div>
                ...
                <h1 class="logo-text">PHP Basic Stacked chart example</h1>
            </div>
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    ...
                    <div class="gen-chart-render">
                        ...
                        echo renderChart("../../FusionCharts/StackedColumn3D.swf", "Data/MSData.xml", "", "myFirst", 600, 300, false, true);
