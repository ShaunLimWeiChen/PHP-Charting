...
<HTML>
    <head>
        ...
        <title>FusionCharts - Simple Dual Y Axis Combination chart</title>
        ...
        <div id="wrapper">
            ...
            <div id="header">
               ...
               <div class="logo"><a class="imagelink"  href="http://www.fusioncharts.com/" target="_blank"><img src="../assets/ui/images/fusionchartsv3.2-logo.png" width="131" height="75" alt="FusionCharts XT logo" /></a></div>
                ...
                <h1 class="logo-text">PHP Basic Dual Y Axis chart examples</h1>
            </div>

            <div class="content-area">
                <div id="content-area-inner-main">
                    <h2 class="headline">Basic example using pre-built CDYData.xml</h2>

                    <div class="gen-chart-render">
                        <?php

                        //This page demonstrates the ease of generating charts using FusionCharts.
                        //For this chart, we've used a pre-defined CDYData.xml (contained in /Data/ folder)
                        //Ideally, you would NOT use a physical data file. Instead you'll have
                        //your own PHP scripts virtually relay the XML data document. Such examples are also present.
                        //For a head-start, we've kept this example very simple.


                        //Create the chart - Column 3D Chart with data from Data/CDYData.xml
                        echo renderChart("../../FusionCharts/MSCombiDY2D.swf", "Data/CDYData.xml", "", "myFirst", 600, 300, false, true);
