...
<HTML>
    <head>
        ...
        <title>FusionCharts - Simple Combination chart</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    <h2 class="headline">Basic example using pre-built CSYData.xml</h2>

                    <div class="gen-chart-render">
                        <?php

                        //This page demonstrates the ease of generating charts using FusionCharts.
                        //For this chart, we've used a pre-defined CSYData.xml (contained in /Data/ folder)
                        ...
                        echo renderChart("../../FusionCharts/Column3D.swf", "Data/CSYData.xml", "", "myFirst", 600, 300, false, true);
