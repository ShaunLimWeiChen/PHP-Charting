        ...
        <div id="wrapper">
            ...
            <div class="content-area">
                <div id="content-area-inner-main">
                    <h2 class="headline">Basic example using pre-built Data.json</h2>
                    ...
                    <div class="gen-chart-render">
                        ...
                        'your own ASP scripts virtually relay the JSON data document. Such examples are also present.
