                ...
                <div id="content-area-inner-main">
                    ...
                    <div class="gen-chart-render">
                        <center>
                            ...
                            ' This will force FusionCharts JavaScript class to render pure JavaScript chart
                            ...
                            Call renderChart("../../FusionCharts/Line.swf", "Data/Data.xml", "", "chart2", 600, 300, false, true)
                            %>
                            <BR><BR>
                            <%
									Call FC_SetRenderer( "javascript" )
                            ' Now, create a Area 2D Chart
                            Call renderChart("../../FusionCharts/Area2D.swf", "Data/Data.xml", "", "chart3", 600, 300, false, true)
                            %>
                        </center>
                    </div>
                    <div class="clear"></div>
